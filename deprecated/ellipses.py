...
def main():
    line_w  = None if SAVE_PLOT else 4
    ...
    if PLOT_ALL:
        graph = gu.Graph('J2325_4111 Quads', 'X (pixels)', 'Y (pixels)')
    ...
    for idx, sys in enumerate(systems):
        ...
        images = sys.images.copy() - 600           # recenter
        ...
        graph.fig.update_layout(title=name)
